...
sudo git clone https://sepehrabdous96:raGV9hCmJXrQCzHaZ4EX@bitbucket.org/scalable-mcast/ls_collectives_combination_1pergpu_8MB_64_50.git /mnt/data/OneDrive/mburst_simulations/forwarding_dbs/distributions/
