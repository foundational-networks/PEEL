...
sudo git clone https://sepehrabdous96:raGV9hCmJXrQCzHaZ4EX@bitbucket.org/scalable-mcast/ft_collectives_broadcast_dscale_constant_load_30.git /mnt/data/OneDrive/mburst_simulations/forwarding_dbs/distributions/
