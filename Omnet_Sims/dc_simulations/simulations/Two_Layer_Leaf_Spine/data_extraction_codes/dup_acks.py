                                                    ...
                                                    with gzip.open(directory1 + file_name + '.gz', 'rt') as csv_file:
                                                        ...
                                                        for row in csv_reader:
                                                            if first_line:
                                                                ...
                                                                row1 = row
                                                                continue
                                                            dup_acks_num += int(row[-1])

                                                    dup_acks_num_array.append(dup_acks_num)

                                                print("Info for filename: {}".format(file_name))
                                                print('average number of dup ACKS is {}\n'.format(np.mean(dup_acks_num_array)))
                                                print('--------------------------------------------')
