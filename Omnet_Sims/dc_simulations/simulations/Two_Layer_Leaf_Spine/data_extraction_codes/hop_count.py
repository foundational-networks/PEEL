                                                    ...
                                                    for rep_num in range(REP_NUM):
                                                        ...
                                                        with gzip.open(directory1 + file_name + '.gz', 'rt') as csv_file:
                                                            ...
                                                            for row in csv_reader:
                                                                ...
                                                                # we have mean and sum, we need mean
                                                                if "mean" in row[-2]:
                                                                    hop_count_array.append(float(row[-1]))
                                                    avg_hop_count = np.mean(hop_count_array)
                                                    avg_hop_count_array.append(avg_hop_count)

                                                    print(file_name.replace("_",","))
                                                    print('average hop count\n{}'.format(
                                                        np.mean(avg_hop_count)))
                                                    print()
                                                except:
                                                    print(file_name.replace("_",","))
                                                    print('average hop count\n{}'.format(
