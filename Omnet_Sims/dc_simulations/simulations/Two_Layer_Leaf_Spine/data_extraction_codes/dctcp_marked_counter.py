...
directory1 = BASE_DIR + 'NUM_PACKETS_MARKED_DCTCP/'

print("DCTCP Marked Counter")
                                                    ...
                                                    for rep_num in range(REP_NUM):
                                                        ...
                                                        with gzip.open(directory1 + file_name + '.gz', 'rt') as csv_file:
                                                            ...
                                                            for row in csv_reader:
                                                                ...
                                                                dctcp_marked_pkts += int(row[-1])

                                                        dctcp_marked_pkts_array.append(dctcp_marked_pkts)

                                                    print(file_name.replace("_",","))
                                                    print('average number of pkts marked by DCTCP segments\n {}'.format(
                                                        np.mean(dctcp_marked_pkts_array)))
                                                    print()
                                                except:
                                                    print(file_name.replace("_",","))
                                                    print('average number of pkts marked by DCTCP segments\n {}'.format(0))
