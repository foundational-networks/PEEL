...
python3 plotter_linechart.py --input_file_path archive/ls_allreduce_dfsize.txt --output_fig_path figs/ls_allreduce_dfsize --cases 2 8 32 128 512 --x_axis_title "Message Size (MB)"
