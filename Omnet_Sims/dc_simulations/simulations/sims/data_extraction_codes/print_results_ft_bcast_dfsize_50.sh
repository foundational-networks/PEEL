...
python plotter_linechart.py --input_file_path archive/ft_bcast_dfsize_50.txt --output_fig_path figs/ft_bcast_dfsize_50 --cases 2 8 32 128 512 --x_axis_title "Message Size (MB)"
