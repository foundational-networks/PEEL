...
directory1 = BASE_DIR + 'LIGHT_BYTES_PER_SEC/'
                        ...
                        for chunksize in CHUNK_SIZES:
                            for subf_num in SUB_FLOW_NUMS:
                                ...
                                for rep_num in range(REP_NUM):
                                    ...
                                    utilization_list_mbps = [u/(10**6) for u in utilization_list]
                                    active_leaf_utilization_list_mbps = [u/(10**6) for u in active_leaf_utilization_list]
                                    spine_to_leaf_utilization_mbps =  [u/(10**6) for u in spine_to_leaf_utilization]
