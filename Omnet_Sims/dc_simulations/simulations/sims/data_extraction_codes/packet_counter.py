...
directory1 = BASE_DIR + 'IP_PACKET_SENT_COUNTER/'
directory2 = BASE_DIR + 'IP_DATA_PACKET_SENT_COUNTER/'
                                                    ...
                                                    for rep_num in range(REP_NUM):
                                                        ...
                                                        with gzip.open(directory1 + file_name + '.gz', 'rt') as csv_file:
                                                            ...
                                                            for row in csv_reader:
                                                                ...
                                                                packet_num += int(row[-1])

                                                        fast_packet_array.append(packet_num)
                                                        ...
                                                        try:
                                                            with gzip.open(directory2 + file_name + '.gz', 'rt') as csv_file:
                                                                ...
                                                                for row in csv_reader:
                                                                    ...
                                                                    data_packet_num += int(row[-1])
                                                        except:
                                                            pass
                                                        fast_data_packet_array.append(data_packet_num)

                                                    print(file_name.replace("_",","))
                                                    print('Total packets, Data packets\n{},{}'.format(np.mean(fast_packet_array),
                                                                                                     np.mean(fast_data_packet_array),))
                                                    print()
                                                except:
                                                    print(file_name.replace("_",","))
                                                    print('Total packets, Data packets\n{},{}'.format(0,
