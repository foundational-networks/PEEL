...
python3 plotter_linechart.py --input_file_path archive/ls_bcast_dfsize_50.txt --output_fig_path figs/ls_bcast_dfsize_50 --cases 2 8 32 128 512 --x_axis_title "Message Size (MB)"
