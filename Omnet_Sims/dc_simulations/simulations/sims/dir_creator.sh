...
sudo mkdir extracted_results/FLOW_STARTED_COLLECTIVE_TYPE
sudo mkdir extracted_results/FLOW_STARTED_COLLECTIVE_ALG
...
sudo mkdir extracted_results/BITS_RCVD_LENGTH
sudo mkdir extracted_results/FLOW_NUM_PER_QUERY
sudo mkdir extracted_results/FLOW_PASSED
sudo mkdir extracted_results/PFC_STOP_GENERATED
sudo mkdir extracted_results/AGG_POPPED_BYTES
sudo mkdir extracted_results/POPPED_DATA_PKT_NUM
sudo mkdir extracted_results/LIGHT_LAST_DATA_POPPED_TIME
sudo mkdir extracted_results/LIGHT_TREE_COUNTER
sudo mkdir extracted_results/LIGHT_DATA_PKT_SENT_NUM
sudo mkdir extracted_results/LIGHT_DATA_PKT_RCVD_NUM
sudo mkdir extracted_results/LIGHT_OOO_DATA_COUNT
sudo mkdir extracted_results/CONTROLLER_DELAY
sudo mkdir extracted_results/MAX_SIMULTANEOUS_TREES
sudo mkdir extracted_results/AUTOCCL_CHOSEN_ALG
sudo mkdir extracted_results/AUTOCCL_CHOSEN_COLLECTIVE
