...
sudo git clone https://sepehrabdous96:raGV9hCmJXrQCzHaZ4EX@bitbucket.org/scalable-mcast/ft_collectives_broadcast_dfsize_constant_load_70.git /mnt/data/OneDrive/mburst_simulations/forwarding_dbs/distributions/
