...
sudo git clone https://sepehrabdous96:raGV9hCmJXrQCzHaZ4EX@bitbucket.org/scalable-mcast/ls_collectives_broadcast_1pergpu_dscale_constant_load_50.git /mnt/data/OneDrive/mburst_simulations/forwarding_dbs/distributions/
