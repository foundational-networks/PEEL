...
class INET_API AugmentedEtherMac : public EtherMacBase
{
  ...
  protected:
    ...
    static simsignal_t pfcGeneratedSignal;
...
//    B pfc_bytes_counter = B(0);
    bool use_pfc = false;
    Packet* base_signal_packet = nullptr;
    void generate_and_send_pfc_signal(uint8 signal);
  ...
  protected:
    ...
    virtual void generate_base_signal_packet(Packet *packet_dup);
