...
#ifndef __INET_SHORTTCPAPPBASE_H
#define __INET_SHORTTCPAPPBASE_H
 ...
 */
class INET_API ShortTcpAppBase : public ApplicationBase, public TcpSocket::ICallback
{
  protected:
    ...
    std::map<TcpSocket*, int> socket_dstserveridx_mapper; // maps a socket to a query id


  protected:
    virtual ~ShortTcpAppBase();
    ...
    /* Utility functions */
    virtual void connect(int dest_server_idx, int connect_port, unsigned long query_id=0);
...
#endif // ifndef __INET_SHORTTCPAPPBASE_H
