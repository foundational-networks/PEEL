...
#ifndef __INET_LONGRUNNINGSOCKETTCPAPPBASE_H
#define __INET_LONGRUNNINGSOCKETTCPAPPBASE_H
 ...
 */
class INET_API LongRunningSocketTcpAppBase : public ApplicationBase, public TcpSocket::ICallback
{
  protected:
  ...
  protected:
    virtual ~LongRunningSocketTcpAppBase();
...
#endif // ifndef __INET_LONGRUNNINGSOCKETTCPAPPBASE_H
