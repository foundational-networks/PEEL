...
int IsBurstyTagDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0] == 'i' && strcmp(fieldName, "is_bursty") == 0) return base+0;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
int IsBurstyTagDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    IsBurstyTag *pp = (IsBurstyTag *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *IsBurstyTagDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string IsBurstyTagDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool IsBurstyTagDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *IsBurstyTagDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int PayloadInfoTagDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0] == 'p' && strcmp(fieldName, "payload_length") == 0) return base+0;
    if (fieldName[0] == 't' && strcmp(fieldName, "total_length") == 0) return base+1;
...
int PayloadInfoTagDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    PayloadInfoTag *pp = (PayloadInfoTag *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *PayloadInfoTagDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string PayloadInfoTagDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool PayloadInfoTagDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *PayloadInfoTagDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
Register_Class(InputPortTag)

InputPortTag::InputPortTag() : ::inet::TagBase()
{
}

InputPortTag::InputPortTag(const InputPortTag& other) : ::inet::TagBase(other)
{
    copy(other);
}

InputPortTag::~InputPortTag()
{
}

InputPortTag& InputPortTag::operator=(const InputPortTag& other)
{
    if (this == &other) return *this;
    ::inet::TagBase::operator=(other);
    copy(other);
...
void InputPortTag::copy(const InputPortTag& other)
{
    this->input_port_idx = other.input_port_idx;
}

void InputPortTag::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::inet::TagBase::parsimPack(b);
    doParsimPacking(b,this->input_port_idx);
}

void InputPortTag::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::TagBase::parsimUnpack(b);
    doParsimUnpacking(b,this->input_port_idx);
}

int InputPortTag::getInput_port_idx() const
{
    return this->input_port_idx;
}

void InputPortTag::setInput_port_idx(int input_port_idx)
{
    this->input_port_idx = input_port_idx;
}

class InputPortTagDescriptor : public omnetpp::cClassDescriptor
{
  private:
    mutable const char **propertynames;
    enum FieldConstants {
        FIELD_input_port_idx,
    };
  public:
    InputPortTagDescriptor();
    virtual ~InputPortTagDescriptor();
...
Register_ClassDescriptor(InputPortTagDescriptor)

InputPortTagDescriptor::InputPortTagDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::InputPortTag)), "inet::TagBase")
{
    propertynames = nullptr;
}

InputPortTagDescriptor::~InputPortTagDescriptor()
{
    delete[] propertynames;
}

bool InputPortTagDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<InputPortTag *>(obj)!=nullptr;
}

const char **InputPortTagDescriptor::getPropertyNames() const
{
    if (!propertynames) {
        static const char *names[] = {  nullptr };
        omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *InputPortTagDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int InputPortTagDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 1+basedesc->getFieldCount() : 1;
}

unsigned int InputPortTagDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_input_port_idx
    };
    return (field >= 0 && field < 1) ? fieldTypeFlags[field] : 0;
}

const char *InputPortTagDescriptor::getFieldName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int InputPortTagDescriptor::findField(const char *fieldName) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount() : 0;
    if (fieldName[0] == 'i' && strcmp(fieldName, "input_port_idx") == 0) return base+0;
    return basedesc ? basedesc->findField(fieldName) : -1;
}

const char *InputPortTagDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    static const char *fieldTypeStrings[] = {
        "int",    // FIELD_input_port_idx
    };
    return (field >= 0 && field < 1) ? fieldTypeStrings[field] : nullptr;
}

const char **InputPortTagDescriptor::getFieldPropertyNames(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *InputPortTagDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int InputPortTagDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    InputPortTag *pp = (InputPortTag *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *InputPortTagDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string InputPortTagDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    InputPortTag *pp = (InputPortTag *)object; (void)pp;
    switch (field) {
        case FIELD_input_port_idx: return long2string(pp->getInput_port_idx());
        default: return "";
    }
}

bool InputPortTagDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    InputPortTag *pp = (InputPortTag *)object; (void)pp;
    switch (field) {
        case FIELD_input_port_idx: pp->setInput_port_idx(string2long(value)); return true;
        default: return false;
    }
}

const char *InputPortTagDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *InputPortTagDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
