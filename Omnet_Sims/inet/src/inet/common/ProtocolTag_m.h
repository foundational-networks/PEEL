...
/**
 * Class generated from <tt>inet/common/ProtocolTag.msg:121</tt> by nedtool.
 * <pre>
 ...
 * </pre>
 */
class INET_API IsBurstyTag : public ::inet::TagBase
{
  protected:
    bool is_bursty = false;

  private:
    void copy(const IsBurstyTag& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const IsBurstyTag&);

  public:
    IsBurstyTag();
    IsBurstyTag(const IsBurstyTag& other);
    virtual ~IsBurstyTag();
    IsBurstyTag& operator=(const IsBurstyTag& other);
    virtual IsBurstyTag *dup() const override {return new IsBurstyTag(*this);}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;
...
inline void doParsimPacking(omnetpp::cCommBuffer *b, const IsBurstyTag& obj) {obj.parsimPack(b);}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, IsBurstyTag& obj) {obj.parsimUnpack(b);}

/**
 * Class generated from <tt>inet/common/ProtocolTag.msg:126</tt> by nedtool.
 * <pre>
 ...
 * </pre>
 */
class INET_API PayloadInfoTag : public ::inet::TagBase
{
  protected:
    b payload_length = b(0);
    b total_length = b(0);
  ...
  private:
    void copy(const PayloadInfoTag& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const PayloadInfoTag&);

  public:
    PayloadInfoTag();
    PayloadInfoTag(const PayloadInfoTag& other);
    virtual ~PayloadInfoTag();
    PayloadInfoTag& operator=(const PayloadInfoTag& other);
    virtual PayloadInfoTag *dup() const override {return new PayloadInfoTag(*this);}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;
...
inline void doParsimPacking(omnetpp::cCommBuffer *b, const PayloadInfoTag& obj) {obj.parsimPack(b);}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, PayloadInfoTag& obj) {obj.parsimUnpack(b);}

/**
 * Class generated from <tt>inet/common/ProtocolTag.msg:133</tt> by nedtool.
 * <pre>
 * class InputPortTag extends TagBase
 * {
 *     int input_port_idx = -1;
 * }
 * </pre>
 */
class INET_API InputPortTag : public ::inet::TagBase
{
  protected:
    int input_port_idx = -1;

  private:
    void copy(const InputPortTag& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const InputPortTag&);

  public:
    InputPortTag();
    InputPortTag(const InputPortTag& other);
    virtual ~InputPortTag();
    InputPortTag& operator=(const InputPortTag& other);
    virtual InputPortTag *dup() const override {return new InputPortTag(*this);}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const override;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b) override;

    // field getter/setter methods
    virtual int getInput_port_idx() const;
    virtual void setInput_port_idx(int input_port_idx);
};

inline void doParsimPacking(omnetpp::cCommBuffer *b, const InputPortTag& obj) {obj.parsimPack(b);}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, InputPortTag& obj) {obj.parsimUnpack(b);}
