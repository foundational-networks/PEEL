...
Register_Class(Ipv4OptionV2Marking)

Ipv4OptionV2Marking::Ipv4OptionV2Marking() : ::inet::Ipv4Option()
{
    this->setType(IPOPTION_V2_MARKING);
    this->setLength(8);

}

Ipv4OptionV2Marking::Ipv4OptionV2Marking(const Ipv4OptionV2Marking& other) : ::inet::Ipv4Option(other)
{
    copy(other);
}

Ipv4OptionV2Marking::~Ipv4OptionV2Marking()
{
}

Ipv4OptionV2Marking& Ipv4OptionV2Marking::operator=(const Ipv4OptionV2Marking& other)
{
    if (this == &other) return *this;
    ::inet::Ipv4Option::operator=(other);
    copy(other);
...
void Ipv4OptionV2Marking::copy(const Ipv4OptionV2Marking& other)
{
    this->flow_let_id = other.flow_let_id;
    this->seq = other.seq;
    this->ret_num = other.ret_num;
    this->is_first_packet = other.is_first_packet;
    this->is_control_message = other.is_control_message;
}

void Ipv4OptionV2Marking::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::inet::Ipv4Option::parsimPack(b);
    doParsimPacking(b,this->flow_let_id);
    doParsimPacking(b,this->seq);
    doParsimPacking(b,this->ret_num);
    doParsimPacking(b,this->is_first_packet);
    doParsimPacking(b,this->is_control_message);
}

void Ipv4OptionV2Marking::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::Ipv4Option::parsimUnpack(b);
    doParsimUnpacking(b,this->flow_let_id);
    doParsimUnpacking(b,this->seq);
    doParsimUnpacking(b,this->ret_num);
    doParsimUnpacking(b,this->is_first_packet);
    doParsimUnpacking(b,this->is_control_message);
}

int Ipv4OptionV2Marking::getFlow_let_id() const
{
    return this->flow_let_id;
}

void Ipv4OptionV2Marking::setFlow_let_id(int flow_let_id)
{
    this->flow_let_id = flow_let_id;
}

unsigned long Ipv4OptionV2Marking::getSeq() const
{
    return this->seq;
}

void Ipv4OptionV2Marking::setSeq(unsigned long seq)
{
    this->seq = seq;
}

unsigned long Ipv4OptionV2Marking::getRet_num() const
{
    return this->ret_num;
}

void Ipv4OptionV2Marking::setRet_num(unsigned long ret_num)
{
    this->ret_num = ret_num;
}

bool Ipv4OptionV2Marking::getIs_first_packet() const
{
    return this->is_first_packet;
}

void Ipv4OptionV2Marking::setIs_first_packet(bool is_first_packet)
{
    this->is_first_packet = is_first_packet;
}

bool Ipv4OptionV2Marking::getIs_control_message() const
{
    return this->is_control_message;
}

void Ipv4OptionV2Marking::setIs_control_message(bool is_control_message)
{
    this->is_control_message = is_control_message;
}
...
class Ipv4OptionV2MarkingDescriptor : public omnetpp::cClassDescriptor
{
  private:
    ...
    enum FieldConstants {
        ...
        FIELD_seq,
        FIELD_ret_num,
        FIELD_is_first_packet,
        FIELD_is_control_message,
    };
  public:
    Ipv4OptionV2MarkingDescriptor();
    virtual ~Ipv4OptionV2MarkingDescriptor();
...
{
    return dynamic_cast<Ipv4OptionV2Marking *>(obj)!=nullptr;
}
...
unsigned int Ipv4OptionV2MarkingDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_ret_num
        FD_ISEDITABLE,    // FIELD_is_first_packet
        FD_ISEDITABLE,    // FIELD_is_control_message
    };
    return (field >= 0 && field < 5) ? fieldTypeFlags[field] : 0;
}
...
const char *Ipv4OptionV2MarkingDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "unsigned long",    // FIELD_seq
        "unsigned long",    // FIELD_ret_num
        "bool",    // FIELD_is_first_packet
        "bool",    // FIELD_is_control_message
    };
    return (field >= 0 && field < 5) ? fieldTypeStrings[field] : nullptr;
}
...
std::string Ipv4OptionV2MarkingDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_ret_num: return ulong2string(pp->getRet_num());
        case FIELD_is_first_packet: return bool2string(pp->getIs_first_packet());
        case FIELD_is_control_message: return bool2string(pp->getIs_control_message());
        default: return "";
    }
}
...
Register_Class(Ipv4OptionSwift)

Ipv4OptionSwift::Ipv4OptionSwift() : ::inet::Ipv4Option()
{
    this->setType(IP_SWIFT_OVERHEAD);
    this->setLength(5);
}

Ipv4OptionSwift::Ipv4OptionSwift(const Ipv4OptionSwift& other) : ::inet::Ipv4Option(other)
{
    copy(other);
}

Ipv4OptionSwift::~Ipv4OptionSwift()
{
}

Ipv4OptionSwift& Ipv4OptionSwift::operator=(const Ipv4OptionSwift& other)
{
    if (this == &other) return *this;
    ::inet::Ipv4Option::operator=(other);
    copy(other);
...
void Ipv4OptionSwift::copy(const Ipv4OptionSwift& other)
{
}

void Ipv4OptionSwift::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::inet::Ipv4Option::parsimPack(b);
}

void Ipv4OptionSwift::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::inet::Ipv4Option::parsimUnpack(b);
}
...
class Ipv4OptionSwiftDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    Ipv4OptionSwiftDescriptor();
    virtual ~Ipv4OptionSwiftDescriptor();
...
{
    return dynamic_cast<Ipv4OptionSwift *>(obj)!=nullptr;
}
...
void Ipv4Header::copy(const Ipv4Header& other)
{
    ...
    this->original_src_port = other.original_src_port;
    this->original_dst_port = other.original_dst_port;
}
...
void Ipv4Header::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->original_src_port);
    doParsimPacking(b,this->original_dst_port);
}
...
void Ipv4Header::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->original_src_port);
    doParsimUnpacking(b,this->original_dst_port);
}
...
unsigned int Ipv4Header::getOriginal_src_port() const
{
    return this->original_src_port;
}

void Ipv4Header::setOriginal_src_port(unsigned int original_src_port)
{
    handleChange();
    this->original_src_port = original_src_port;
}

unsigned int Ipv4Header::getOriginal_dst_port() const
{
    return this->original_dst_port;
}

void Ipv4Header::setOriginal_dst_port(unsigned int original_dst_port)
{
    handleChange();
    this->original_dst_port = original_dst_port;
}
...
class Ipv4HeaderDescriptor : public omnetpp::cClassDescriptor
{
  private:
    ...
    enum FieldConstants {
        ...
        FIELD_destAddress,
        FIELD_options,
        FIELD_original_src_port,
        FIELD_original_dst_port,
    };
  public:
...
unsigned int Ipv4HeaderDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_original_src_port
        FD_ISEDITABLE,    // FIELD_original_dst_port
    };
...
int Ipv4HeaderDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'o' && strcmp(fieldName, "original_src_port") == 0) return base+17;
    if (fieldName[0] == 'o' && strcmp(fieldName, "original_dst_port") == 0) return base+18;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
const char *Ipv4HeaderDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "unsigned int",    // FIELD_original_src_port
        "unsigned int",    // FIELD_original_dst_port
    };
...
std::string Ipv4HeaderDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_original_src_port: return ulong2string(pp->getOriginal_src_port());
        case FIELD_original_dst_port: return ulong2string(pp->getOriginal_dst_port());
        default: return "";
    }
}
...
bool Ipv4HeaderDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_original_src_port: pp->setOriginal_src_port(string2ulong(value)); return true;
        case FIELD_original_dst_port: pp->setOriginal_dst_port(string2ulong(value)); return true;
        default: return false;
    }
}
