...
class INET_API TcpBaseAlg : public TcpAlgorithm
{
  ...
  protected:
    ...
    void reduce_rate_based_on_FR() {throw cRuntimeError("reduce_rate_based_on_FR not implemented!");}

    void reduce_rate_based_on_RTO() {throw cRuntimeError("reduce_rate_based_on_RTO not implemented!");}
