...
// rate limiting due to deflection types
#define DEF_NO_LIMIT 0
#define DEF_FR_LIMIT 1
#define DEF_RTO_LIMIT 2
#define DEF_REGULAR_REACTION_LIMIT 3
...
class INET_API TcpStateVariables : public cObject
{
  ...
  public:
    ...
    // piggybacking deflection
    bool main_packet_deflected;
    int def_rate_limiting_type;
    bool use_one_decrease_threshold;
    bool def_rate_limit_update_cwnd_once_per_rtt;
    uint32 deflection_DCTCPWindowEnd;
    simtime_t deflection_TcpeceReactionTime;
    ...
    bool use_long_running_flows = false;
};
...
class INET_API TcpConnection : public cSimpleModule
{
  public:
    ...
    // echoing deflection
    bool is_packet_deflected = false;
  ...
  public:
    /** Utility: send ACK */
    virtual void sendAck(simtime_t receive_time_to_be_echoed = 0, unsigned int hop_count_to_be_echoed = 0, bool is_main_packet_deflected = false);
