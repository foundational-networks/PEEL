...
/**
 * Class generated from <tt>inet/transportlayer/tcp_common/TcpHeader.msg:120</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/transportlayer/tcp_common/TcpHeader.msg:126</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/transportlayer/tcp_common/TcpHeader.msg:132</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/transportlayer/tcp_common/TcpHeader.msg:139</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/transportlayer/tcp_common/TcpHeader.msg:146</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/transportlayer/tcp_common/TcpHeader.msg:152</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/transportlayer/tcp_common/TcpHeader.msg:159</tt> by nedtool.
 * <pre>
...
class INET_API TcpOptionTimestamp : public ::inet::tcp::TcpOption
{
  protected:
    ...
    omnetpp::simtime_t echoedTimestamp = SIMTIME_ZERO;
  ...
  public:
    ...
    virtual omnetpp::simtime_t getEchoedTimestamp() const;
    virtual void setEchoedTimestamp(omnetpp::simtime_t echoedTimestamp);
};
...
/**
 * Class generated from <tt>inet/transportlayer/tcp_common/TcpHeader.msg:167</tt> by nedtool.
 * <pre>
...
/**
 * Class generated from <tt>inet/transportlayer/tcp_common/TcpHeader.msg:187</tt> by nedtool.
 * <pre>
 * //
 ...
 *     bool is_main_packet_deflected = false;
 * 
 *     // bolt
 *     bool srcbit = false;
 *     bool bolt_dec = false;
 *     bool bolt_inc = false;
 *     bool bolt_last = false;
 *     bool bolt_first = false;
 *     simtime_t bolt_tx_time;
 *     int queue_occupancy_packet_num;
 *     long link_util;
 * }
 * </pre>
 */
class INET_API TcpHeader : public ::inet::TransportHeaderBase
{
  protected:
    ...
    omnetpp::simtime_t rcvd_time_to_be_echod = 0;
    unsigned int hop_count_to_be_echoed = 0;
    bool is_main_packet_deflected = false;
    bool srcbit = false;
    bool bolt_dec = false;
    bool bolt_inc = false;
    bool bolt_last = false;
    bool bolt_first = false;
    omnetpp::simtime_t bolt_tx_time = SIMTIME_ZERO;
    int queue_occupancy_packet_num = 0;
    long link_util = 0;
  ...
  public:
    ...
    virtual bool getWait_for_whole_pack_from_gro() const;
    virtual void setWait_for_whole_pack_from_gro(bool wait_for_whole_pack_from_gro);
    ...
    virtual omnetpp::simtime_t getRcvd_time_to_be_echod() const;
    virtual void setRcvd_time_to_be_echod(omnetpp::simtime_t rcvd_time_to_be_echod);
    virtual unsigned int getHop_count_to_be_echoed() const;
    virtual void setHop_count_to_be_echoed(unsigned int hop_count_to_be_echoed);
    virtual bool getIs_main_packet_deflected() const;
    virtual void setIs_main_packet_deflected(bool is_main_packet_deflected);
    virtual bool getSrcbit() const;
    virtual void setSrcbit(bool srcbit);
    virtual bool getBolt_dec() const;
    virtual void setBolt_dec(bool bolt_dec);
    virtual bool getBolt_inc() const;
    virtual void setBolt_inc(bool bolt_inc);
    virtual bool getBolt_last() const;
    virtual void setBolt_last(bool bolt_last);
    virtual bool getBolt_first() const;
    virtual void setBolt_first(bool bolt_first);
    virtual omnetpp::simtime_t getBolt_tx_time() const;
    virtual void setBolt_tx_time(omnetpp::simtime_t bolt_tx_time);
    virtual int getQueue_occupancy_packet_num() const;
    virtual void setQueue_occupancy_packet_num(int queue_occupancy_packet_num);
    virtual long getLink_util() const;
    virtual void setLink_util(long link_util);
