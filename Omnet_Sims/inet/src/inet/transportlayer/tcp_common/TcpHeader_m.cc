...
omnetpp::simtime_t TcpOptionTimestamp::getSenderTimestamp() const
{
    return this->senderTimestamp;
}

void TcpOptionTimestamp::setSenderTimestamp(omnetpp::simtime_t senderTimestamp)
{
    this->senderTimestamp = senderTimestamp;
}

omnetpp::simtime_t TcpOptionTimestamp::getEchoedTimestamp() const
{
    return this->echoedTimestamp;
}

void TcpOptionTimestamp::setEchoedTimestamp(omnetpp::simtime_t echoedTimestamp)
{
...
unsigned int TcpOptionTimestampDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        0,    // FIELD_senderTimestamp
        0,    // FIELD_echoedTimestamp
    };
    return (field >= 0 && field < 2) ? fieldTypeFlags[field] : 0;
}
...
const char *TcpOptionTimestampDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "omnetpp::simtime_t",    // FIELD_echoedTimestamp
    };
    return (field >= 0 && field < 2) ? fieldTypeStrings[field] : nullptr;
}
...
std::string TcpOptionTimestampDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_echoedTimestamp: return simtime2string(pp->getEchoedTimestamp());
        default: return "";
    }
}
...
void TcpHeader::copy(const TcpHeader& other)
{
    ...
    this->wait_for_whole_pack_from_gro = other.wait_for_whole_pack_from_gro;
    ...
    this->rcvd_time_to_be_echod = other.rcvd_time_to_be_echod;
    this->hop_count_to_be_echoed = other.hop_count_to_be_echoed;
    this->is_main_packet_deflected = other.is_main_packet_deflected;
    this->srcbit = other.srcbit;
    this->bolt_dec = other.bolt_dec;
    this->bolt_inc = other.bolt_inc;
    this->bolt_last = other.bolt_last;
    this->bolt_first = other.bolt_first;
    this->bolt_tx_time = other.bolt_tx_time;
    this->queue_occupancy_packet_num = other.queue_occupancy_packet_num;
    this->link_util = other.link_util;
}
...
void TcpHeader::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->wait_for_whole_pack_from_gro);
    ...
    doParsimPacking(b,this->rcvd_time_to_be_echod);
    doParsimPacking(b,this->hop_count_to_be_echoed);
    doParsimPacking(b,this->is_main_packet_deflected);
    doParsimPacking(b,this->srcbit);
    doParsimPacking(b,this->bolt_dec);
    doParsimPacking(b,this->bolt_inc);
    doParsimPacking(b,this->bolt_last);
    doParsimPacking(b,this->bolt_first);
    doParsimPacking(b,this->bolt_tx_time);
    doParsimPacking(b,this->queue_occupancy_packet_num);
    doParsimPacking(b,this->link_util);
}
...
void TcpHeader::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->wait_for_whole_pack_from_gro);
    ...
    doParsimUnpacking(b,this->rcvd_time_to_be_echod);
    doParsimUnpacking(b,this->hop_count_to_be_echoed);
    doParsimUnpacking(b,this->is_main_packet_deflected);
    doParsimUnpacking(b,this->srcbit);
    doParsimUnpacking(b,this->bolt_dec);
    doParsimUnpacking(b,this->bolt_inc);
    doParsimUnpacking(b,this->bolt_last);
    doParsimUnpacking(b,this->bolt_first);
    doParsimUnpacking(b,this->bolt_tx_time);
    doParsimUnpacking(b,this->queue_occupancy_packet_num);
    doParsimUnpacking(b,this->link_util);
}
...
bool TcpHeader::getWait_for_whole_pack_from_gro() const
{
    return this->wait_for_whole_pack_from_gro;
}

void TcpHeader::setWait_for_whole_pack_from_gro(bool wait_for_whole_pack_from_gro)
{
    handleChange();
    this->wait_for_whole_pack_from_gro = wait_for_whole_pack_from_gro;
}
...
omnetpp::simtime_t TcpHeader::getRcvd_time_to_be_echod() const
{
    return this->rcvd_time_to_be_echod;
}

void TcpHeader::setRcvd_time_to_be_echod(omnetpp::simtime_t rcvd_time_to_be_echod)
{
    handleChange();
    this->rcvd_time_to_be_echod = rcvd_time_to_be_echod;
}

unsigned int TcpHeader::getHop_count_to_be_echoed() const
{
    return this->hop_count_to_be_echoed;
}

void TcpHeader::setHop_count_to_be_echoed(unsigned int hop_count_to_be_echoed)
{
    handleChange();
    this->hop_count_to_be_echoed = hop_count_to_be_echoed;
}

bool TcpHeader::getIs_main_packet_deflected() const
{
    return this->is_main_packet_deflected;
}

void TcpHeader::setIs_main_packet_deflected(bool is_main_packet_deflected)
{
    handleChange();
    this->is_main_packet_deflected = is_main_packet_deflected;
}

bool TcpHeader::getSrcbit() const
{
    return this->srcbit;
}

void TcpHeader::setSrcbit(bool srcbit)
{
    handleChange();
    this->srcbit = srcbit;
}

bool TcpHeader::getBolt_dec() const
{
    return this->bolt_dec;
}

void TcpHeader::setBolt_dec(bool bolt_dec)
{
    handleChange();
    this->bolt_dec = bolt_dec;
}

bool TcpHeader::getBolt_inc() const
{
    return this->bolt_inc;
}

void TcpHeader::setBolt_inc(bool bolt_inc)
{
    handleChange();
    this->bolt_inc = bolt_inc;
}

bool TcpHeader::getBolt_last() const
{
    return this->bolt_last;
}

void TcpHeader::setBolt_last(bool bolt_last)
{
    handleChange();
    this->bolt_last = bolt_last;
}

bool TcpHeader::getBolt_first() const
{
    return this->bolt_first;
}

void TcpHeader::setBolt_first(bool bolt_first)
{
    handleChange();
    this->bolt_first = bolt_first;
}

omnetpp::simtime_t TcpHeader::getBolt_tx_time() const
{
    return this->bolt_tx_time;
}

void TcpHeader::setBolt_tx_time(omnetpp::simtime_t bolt_tx_time)
{
    handleChange();
    this->bolt_tx_time = bolt_tx_time;
}

int TcpHeader::getQueue_occupancy_packet_num() const
{
    return this->queue_occupancy_packet_num;
}

void TcpHeader::setQueue_occupancy_packet_num(int queue_occupancy_packet_num)
{
    handleChange();
    this->queue_occupancy_packet_num = queue_occupancy_packet_num;
}

long TcpHeader::getLink_util() const
{
    return this->link_util;
}

void TcpHeader::setLink_util(long link_util)
{
    handleChange();
    this->link_util = link_util;
}
...
class TcpHeaderDescriptor : public omnetpp::cClassDescriptor
{
  private:
    ...
    enum FieldConstants {
        ...
        FIELD_synBit,
        FIELD_finBit,
        FIELD_wait_for_whole_pack_from_gro,
        FIELD_window,
        FIELD_urgentPointer,
        FIELD_crc,
        FIELD_crcMode,
        FIELD_headerOption,
        FIELD_rcvd_time_to_be_echod,
        FIELD_hop_count_to_be_echoed,
        FIELD_is_main_packet_deflected,
        FIELD_srcbit,
        FIELD_bolt_dec,
        FIELD_bolt_inc,
        FIELD_bolt_last,
        FIELD_bolt_first,
        FIELD_bolt_tx_time,
        FIELD_queue_occupancy_packet_num,
        FIELD_link_util,
    };
  public:
    TcpHeaderDescriptor();
...
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 30+basedesc->getFieldCount() : 30;
}
...
unsigned int TcpHeaderDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_wait_for_whole_pack_from_gro
        ...
        FD_ISEDITABLE,    // FIELD_is_main_packet_deflected
        FD_ISEDITABLE,    // FIELD_srcbit
        FD_ISEDITABLE,    // FIELD_bolt_dec
        FD_ISEDITABLE,    // FIELD_bolt_inc
        FD_ISEDITABLE,    // FIELD_bolt_last
        FD_ISEDITABLE,    // FIELD_bolt_first
        0,    // FIELD_bolt_tx_time
        FD_ISEDITABLE,    // FIELD_queue_occupancy_packet_num
        FD_ISEDITABLE,    // FIELD_link_util
    };
...
const char *TcpHeaderDescriptor::getFieldName(int field) const
{
    ...
    static const char *fieldNames[] = {
        ...
        "synBit",
        "finBit",
        "wait_for_whole_pack_from_gro",
        "window",
        "urgentPointer",
        "crc",
        "crcMode",
        "headerOption",
        "rcvd_time_to_be_echod",
        "hop_count_to_be_echoed",
        "is_main_packet_deflected",
        "srcbit",
        "bolt_dec",
        "bolt_inc",
        "bolt_last",
        "bolt_first",
        "bolt_tx_time",
        "queue_occupancy_packet_num",
        "link_util",
    };
    return (field >= 0 && field < 30) ? fieldNames[field] : nullptr;
}
...
int TcpHeaderDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'c' && strcmp(fieldName, "cwrBit") == 0) return base+5;
    if (fieldName[0] == 'e' && strcmp(fieldName, "eceBit") == 0) return base+6;
    if (fieldName[0] == 'u' && strcmp(fieldName, "urgBit") == 0) return base+7;
    if (fieldName[0] == 'a' && strcmp(fieldName, "ackBit") == 0) return base+8;
    if (fieldName[0] == 'p' && strcmp(fieldName, "pshBit") == 0) return base+9;
    if (fieldName[0] == 'r' && strcmp(fieldName, "rstBit") == 0) return base+10;
    if (fieldName[0] == 's' && strcmp(fieldName, "synBit") == 0) return base+11;
    if (fieldName[0] == 'f' && strcmp(fieldName, "finBit") == 0) return base+12;
    if (fieldName[0] == 'w' && strcmp(fieldName, "wait_for_whole_pack_from_gro") == 0) return base+13;
    if (fieldName[0] == 'w' && strcmp(fieldName, "window") == 0) return base+14;
    if (fieldName[0] == 'u' && strcmp(fieldName, "urgentPointer") == 0) return base+15;
    if (fieldName[0] == 'c' && strcmp(fieldName, "crc") == 0) return base+16;
    if (fieldName[0] == 'c' && strcmp(fieldName, "crcMode") == 0) return base+17;
    if (fieldName[0] == 'h' && strcmp(fieldName, "headerOption") == 0) return base+18;
    if (fieldName[0] == 'r' && strcmp(fieldName, "rcvd_time_to_be_echod") == 0) return base+19;
    if (fieldName[0] == 'h' && strcmp(fieldName, "hop_count_to_be_echoed") == 0) return base+20;
    if (fieldName[0] == 'i' && strcmp(fieldName, "is_main_packet_deflected") == 0) return base+21;
    if (fieldName[0] == 's' && strcmp(fieldName, "srcbit") == 0) return base+22;
    if (fieldName[0] == 'b' && strcmp(fieldName, "bolt_dec") == 0) return base+23;
    if (fieldName[0] == 'b' && strcmp(fieldName, "bolt_inc") == 0) return base+24;
    if (fieldName[0] == 'b' && strcmp(fieldName, "bolt_last") == 0) return base+25;
    if (fieldName[0] == 'b' && strcmp(fieldName, "bolt_first") == 0) return base+26;
    if (fieldName[0] == 'b' && strcmp(fieldName, "bolt_tx_time") == 0) return base+27;
    if (fieldName[0] == 'q' && strcmp(fieldName, "queue_occupancy_packet_num") == 0) return base+28;
    if (fieldName[0] == 'l' && strcmp(fieldName, "link_util") == 0) return base+29;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
const char *TcpHeaderDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "bool",    // FIELD_synBit
        "bool",    // FIELD_finBit
        "bool",    // FIELD_wait_for_whole_pack_from_gro
        ...
        "omnetpp::simtime_t",    // FIELD_rcvd_time_to_be_echod
        "unsigned int",    // FIELD_hop_count_to_be_echoed
        "bool",    // FIELD_is_main_packet_deflected
        "bool",    // FIELD_srcbit
        "bool",    // FIELD_bolt_dec
        "bool",    // FIELD_bolt_inc
        "bool",    // FIELD_bolt_last
        "bool",    // FIELD_bolt_first
        "omnetpp::simtime_t",    // FIELD_bolt_tx_time
        "int",    // FIELD_queue_occupancy_packet_num
        "long",    // FIELD_link_util
    };
    return (field >= 0 && field < 30) ? fieldTypeStrings[field] : nullptr;
}
...
std::string TcpHeaderDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_wait_for_whole_pack_from_gro: return bool2string(pp->getWait_for_whole_pack_from_gro());
        ...
        case FIELD_rcvd_time_to_be_echod: return simtime2string(pp->getRcvd_time_to_be_echod());
        case FIELD_hop_count_to_be_echoed: return ulong2string(pp->getHop_count_to_be_echoed());
        case FIELD_is_main_packet_deflected: return bool2string(pp->getIs_main_packet_deflected());
        case FIELD_srcbit: return bool2string(pp->getSrcbit());
        case FIELD_bolt_dec: return bool2string(pp->getBolt_dec());
        case FIELD_bolt_inc: return bool2string(pp->getBolt_inc());
        case FIELD_bolt_last: return bool2string(pp->getBolt_last());
        case FIELD_bolt_first: return bool2string(pp->getBolt_first());
        case FIELD_bolt_tx_time: return simtime2string(pp->getBolt_tx_time());
        case FIELD_queue_occupancy_packet_num: return long2string(pp->getQueue_occupancy_packet_num());
        case FIELD_link_util: return long2string(pp->getLink_util());
        default: return "";
    }
}
...
bool TcpHeaderDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_cwrBit: pp->setCwrBit(string2bool(value)); return true;
        case FIELD_eceBit: pp->setEceBit(string2bool(value)); return true;
        ...
        case FIELD_wait_for_whole_pack_from_gro: pp->setWait_for_whole_pack_from_gro(string2bool(value)); return true;
        ...
        case FIELD_is_main_packet_deflected: pp->setIs_main_packet_deflected(string2bool(value)); return true;
        ...
        case FIELD_bolt_inc: pp->setBolt_inc(string2bool(value)); return true;
        case FIELD_bolt_last: pp->setBolt_last(string2bool(value)); return true;
        case FIELD_bolt_first: pp->setBolt_first(string2bool(value)); return true;
        case FIELD_queue_occupancy_packet_num: pp->setQueue_occupancy_packet_num(string2long(value)); return true;
        case FIELD_link_util: pp->setLink_util(string2long(value)); return true;
        default: return false;
    }
}
